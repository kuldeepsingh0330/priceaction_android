...
import com.ransankul.priceaction.databinding.ActivityRegisterBinding;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityRegisterBinding.buttonsignUp.setOnClickListener(view -> {
            ...
            String phoneNumber = activityRegisterBinding.editTextphoneNumber.getText().toString();
            ...
            createRequest(name,email,password,phoneNumber);
        });
    ...
    private void createRequest(String name, String email, String password, String phoneNumber) {
        progressDialog.show();
